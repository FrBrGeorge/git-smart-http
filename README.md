...
- Native IPv6 and Dual-stack IPv4/IPv6 support
...
Using IPv4:
```bash
git clone http://127.0.0.1:3000/my-new-repo.git
```

Using IPv6:
```bash
git clone http://[::1]:3000/my-new-repo.git
```
...
- **Read-Write Access (Trusted Host):**
  ...
  ```bash
  git clone http://127.0.0.1:3000/repo.git
  # or for IPv6
  git clone http://[::1]:3000/repo.git
  ```
