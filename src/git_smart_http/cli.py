...
def main(argv: Optional[List[str]] = None):
    ...
    parser.add_argument("-t", "--trusted-host", action="append", help="Add a trusted host IP (can be used multiple times)")
    ...
    if args.trusted_host:
        trusted_addresses.extend(args.trusted_host)

    run_server("::", args.port, args.repo_dir, trusted_addresses)
